        ...
        <div class="lg:w-1/2 mx-auto self-start">
          <div class="mb-10 lg:flex items-center">
            <p class="ml-5 self-center">
              ...
              iure. Inventore necessitatibus suscipit provident quis velit,
              itaque adipisci molestias aut hic ut non voluptate, modi cumque
              accusamus illum laboriosam voluptates cupiditate sed architecto
              distinctio laudantium culpa sint dolore. Aut facere ducimus qui
              est.
            </p>
          </div>
          <h3>Mes skills</h3>
